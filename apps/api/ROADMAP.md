...
complete — PR #28 open against `develop`.
...
`btree_gist`), both manually verified live against a running server.
Pushed and PR #28 opened (https://github.com/Wa39/rentatodo/pull/28),
...
- PR #28 (`feature/reservations` → `develop`) open, awaiting team review.

## Next up (not started)

- [ ] Get PR #28 reviewed and merged

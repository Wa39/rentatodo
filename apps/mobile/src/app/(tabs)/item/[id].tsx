...
const styles = StyleSheet.create({
  ...
  price: { fontSize: 15, fontWeight: '800', color: Brand.primary, marginTop: 2 },
  ...
  chipText: { fontSize: 11, fontWeight: '700', color: Brand.primary },
  owner: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 10,
  ...
  avatarText: { fontSize: 13, fontWeight: '800', color: Brand.primary },
  ...
  summaryValueStrong: { fontSize: 14, fontWeight: '800', color: Brand.primary },

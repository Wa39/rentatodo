...
- Pinned versions (exact, to avoid drift): `vite@^6.0.0`, `react@^18.3.1`, `typescript@^5.6.3`, `react-router-dom@^6.28.0`, `tailwindcss@^3.4.14`, `vitest@^2.1.4`, `@testing-library/react@^16.0.1`, `@testing-library/jest-dom@^6.6.2`, `jsdom@^25.0.1`.
